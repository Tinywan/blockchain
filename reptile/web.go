...
var (
	...
	filePath = "D:\\GoProject\\src\\github.com\\Tinywan\\blockchain\\reptile\\url.txt"
	box      = "D:\\GoProject\\src\\github.com\\Tinywan\\blockchain\\reptile"
)
...
func fistStart() {
	...
	for _, d := range reg.FindAllString(string(body), -1) {
		ff, _ := os.OpenFile(filePath, os.O_RDWR, 0666)
...
func main() {
	//data, err := ioutil.ReadFile("D:\\GoProject\\src\\github.com\\Tinywan\\blockchain\\reptile\\test.txt")
